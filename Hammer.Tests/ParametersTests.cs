...
namespace Hammer.Tests
{
    ...
    public class HammerParametersTests
    {
        ...
        public void CheckParameters_FalseValueHeadWidth_ThrowsArgumentException(double headParametersWidth)
        {
            var hammerParameters = GetDefaultHammerParameters();
        ...
        public void CheckParameters_FalseValueHeadLength_ThrowsArgumentException(double headParametersLength)
        {
            var hammerParameters = GetDefaultHammerParameters();
        ...
        public void CheckParameters_FalseValueHeadHeight_ThrowsArgumentException(double headParametersHeight)
        {
            var hammerParameters = GetDefaultHammerParameters();
        ...
        public void CheckParameters_FalseValueTipWidth_ThrowsArgumentException(double headParametersTipWidth)
        {
            var hammerParameters = GetDefaultHammerParameters();
        ...
        public void CheckParameters_FalseValueToeLength_ThrowsArgumentException(double headParametersToeLength)
        {
            var hammerParameters = GetDefaultHammerParameters();
        ...
        public void CheckParameters_FalseValueHandleDiameter_ThrowsArgumentException(double handleParametersDiameter)
        {
            var hammerParameters = GetDefaultHammerParameters();
        ...
        public void CheckParameters_FalseValueHandleLength_ThrowsArgumentException(double handleParametersLength)
        {
            var hammerParameters = GetDefaultHammerParameters();
